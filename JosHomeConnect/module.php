<?php
	...
	class JosHomeConnect extends WebOAuthModule {
		...
		*/
		...
		public function RequestStatus() {
			...
			//echo $this->FetchData("https://".$this->oauthServer."/forward/homeappliances");
			
			
			$token = $this->FetchAccessToken();
			//setup the request, you can also use CURLOPT_URL
			$ch = curl_init('https://api.home-connect.com/api/homeappliances');
